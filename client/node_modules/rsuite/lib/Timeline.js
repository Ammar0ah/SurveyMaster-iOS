...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, rest), _utils.ReactChildren.mapCloneElement(children, function (child, index) {
      return {
        last: index + 1 === count
      };
    }));
...
(0, _defineProperty2.default)(Timeline, "handledProps", ["children", "className", "classPrefix", "componentClass"]);
